...
import InventoryManagementIntegrationController, {
  Props,
  configJSON
} from "./InventoryManagementIntegrationController";

export default class InventoryManagementIntegration extends InventoryManagementIntegrationController {
