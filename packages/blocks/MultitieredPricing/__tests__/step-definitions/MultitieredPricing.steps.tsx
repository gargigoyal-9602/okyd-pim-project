...
import MultitieredPricing from "../../src/MultitieredPricing"
...
const feature = loadFeature('./__tests__/features/MultitieredPricing-scenario.feature');
...
defineFeature(feature, (test) => {
    ...
    test('User navigates to MultitieredPricing', ({ given, when, then }) => {
        ...
        then('MultitieredPricing will load with out errors', () => {
