...
// var cmd = `cd ../../../../ && node endPointTest.js --host ${host} --path ${config.ordersAPiEndPoint} --method GET`
...
// exec(`cd ../../../.. && node endPointTest.js --host ${host} --path ${config.rateAPiEndPoint} --body '${data}'`, (error, stdout, stderr) => {
//     if (error) {
