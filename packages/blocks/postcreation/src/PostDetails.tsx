...
export default class PostDetails extends PostCreationController {
  ...
  render() {
    // Customizable Area Start
    const data = this.props.navigation && this.props.navigation.state && this.props.navigation.state.params && this.props.navigation.state.params && this.props.navigation.state.params.item && this.props.navigation.state.params.item.data &&  this.props.navigation.state.params.item.data.attributes;
    // Customizable Area End
    return (
        ...
        >
          <KeyboardAvoidingView enabled style={styles.container}>
            ...
            <Image
              ...
              source={{
                uri: data && data.product_image ? data.product_image : null
              }}
            />
            <Text style={styles.textDescriptionTitle}>Post Name:</Text>
            <Text style={styles.textDescription}>{data && data.name ? data.name : ""}</Text>
            <Text style={styles.textDescriptionTitle}>Cost:</Text>
            <Text style={styles.textDescription}>${data && data.price ? data.price : ""}</Text>
            <Text style={styles.textDescriptionTitle}>Description:</Text>
            <Text style={styles.textDescription}>{data && data.description ? data.description : ""}</Text>
            <Text style={styles.textDescriptionTitle}>Post ID:</Text>
            <Text style={styles.textDescription}>{data && data.id ? data.id : "" }</Text>
          </KeyboardAvoidingView>
        </ScrollView>
      {/* Customizable Area End */}
      </SafeAreaView>
