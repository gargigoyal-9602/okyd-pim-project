...
export default class PostCreation extends PostCreationController {
  ...
  render() {
    // Customizable Area Start
    const data = this.props.navigation && this.props.navigation.state && this.props.navigation.state.params && this.props.navigation.state.params.data ? this.props.navigation.state.params.data : [];  
    // Customizable Area End
    return (
