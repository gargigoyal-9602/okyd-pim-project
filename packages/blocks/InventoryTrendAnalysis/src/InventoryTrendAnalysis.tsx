...
import InventoryTrendAnalysisController, {
  Props,
  configJSON
} from "./InventoryTrendAnalysisController";

export default class InventoryTrendAnalysis extends InventoryTrendAnalysisController {
