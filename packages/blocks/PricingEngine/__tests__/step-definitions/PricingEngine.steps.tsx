...
const feature = loadFeature('./__tests__/features/PricingEngine-scenario.feature');
...
defineFeature(feature, (test) => {
    ...
    test('User navigates to PricingEngine', ({ given, when, then }) => {
        let exampleBlockA:ShallowWrapper;
        let instance:PricingEngine; 

        given('I am a User loading PricingEngine', () => {
            exampleBlockA = shallow(<PricingEngine {...screenProps}/>)
        });

        when('I navigate to the PricingEngine', () => {
             instance = exampleBlockA.instance() as PricingEngine
        });
