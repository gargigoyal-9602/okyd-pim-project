...
class BrandEdit extends BrandsController {
  ...
  async componentDidMount() {
    this.brandDetails(this.props.match?.params?.id);
  }
  // Customizable Area End
  render() {
    return (
            ...
            <div className="admin-body-content px-8 py-12">
              <Formik
                initialValues={{
                  ...
                  description: this.state.brandDetailsData?.attributes?.description || RichTextEditor.createEmptyValue(),
                  // description: this.state.brandDetailsData?.attributes?.description || '',
                ...
                render={({ values, setFieldValue, isSubmitting }) => {
                  return (
                    <Form>
                      ...
                      <Field id="brandId" name="brandId" type="hidden" />
