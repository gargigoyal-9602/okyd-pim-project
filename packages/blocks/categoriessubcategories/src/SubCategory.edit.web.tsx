...
interface FormValues {
  ...
  parent_categories: object | number | string;
}
...
class CategoriesSubcategories extends SubCategoriesController {
  ...
  async componentDidMount() {
    this.categoryDetails(this.props.match?.params?.id);
            ...
            <div className="admin-body-content px-8 py-12">
              <Formik
                initialValues={{
                  ...
                  description: this.state.categoryDetailsData?.attributes?.description || RichTextEditor.createEmptyValue(),
                  ...
                  parent_categories: this.state.categoryDetailsData?.attributes?.categories.length > 0 ? { id: this.state.categoryDetailsData?.attributes?.categories[0].id, name: this.state.categoryDetailsData?.attributes?.categories[0].name } : []
                }}
                ...
                enableReinitialize
                render={({ values, setFieldValue, setTouched, isSubmitting }) => {
                  return (
                    <Form>
                      ...
                      <div className="grid grid-cols-2 gap-12 pb-8">
                        <div>
                          ...
                          <div className="field-wrapper mb-6 relative mt-4">
                            ...
                            <div className="field-wrapper mb-6 relative">
                              ...
                              <div>
                                <Switch
                                  ...
                                  checked={values.default_category}
                                  onChange={(e: any): void => {
                                    setFieldValue(
                                      "default_category",
                                      e.target.checked
