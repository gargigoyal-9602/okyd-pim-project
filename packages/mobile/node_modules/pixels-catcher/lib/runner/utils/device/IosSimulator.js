...
class IOSSimulator {
  ...
  constructor(name, canStopDevice) {
    this._name = name;
  ...
  async installApp(appName, appFile) {
  ...
  startApp(appName, activityName, locale) {
